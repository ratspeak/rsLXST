...
impl OpusDecoder {
    pub fn new(sampling_rate: i32, channels: usize) -> Result<Self, &'static str> {
        ...
        Ok(Self {
            ...
            // 60 ms SILK frames can require 960 decoded samples per channel.
            w_pcm_i16: vec![0i16; silk_max_decode_frame_samples(channels)],
...
fn silk_max_decode_frame_samples(channels: usize) -> usize {
    const MAX_SILK_INTERNAL_SAMPLE_RATE: usize = 16_000;
    const MAX_FRAME_DURATION_MS: usize = 60;
    (MAX_SILK_INTERNAL_SAMPLE_RATE * MAX_FRAME_DURATION_MS / 1000) * channels
}
